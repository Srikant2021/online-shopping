	...
	<form action="addressPaymentForOrderAction.jsp" method="post">
		<div class="left-div">
			...
			<input class="input-style" type="text" name="address"
				value="<%=rs2.getString(7)%>" placeholder="Enter Adress" required>
		</div>
		...
		<h3 style="color: red">
			<!--  *If there is no address its mean that you did not set you address!-->
		</h3>
		...
		<div class="right-div">
			<h3>Details of online transaction</h3>
		...
		<div class="left-div">
			...
			<input class="input-style" type="text" name="mobileNumber"
				value="<%=rs2.getString(3)%>" placeholder="Enter Mobile " required>
		...
		<div class="right-div">
			<h3 style="color: red">
				&#8623
				<!--  *If you enter wrong transaction id then your order will we can cancel!-->
			</h3>
			<button class="button" type="submit">
				Confirm Order & Generate Bill <i
